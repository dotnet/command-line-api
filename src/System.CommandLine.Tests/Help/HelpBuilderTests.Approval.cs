    ...
    public partial class HelpBuilderTests
    {
        ...
        public void Help_layout_has_not_changed()
        {
            var command = new RootCommand(description: "Test description")
            {
                ...
                new Option<bool>("the-root-option-no-arg", aliases: new string[] {"--the-root-option-no-arg", "-trna"}) {
                    Description = "the-root-option-no-arg-description",
                    IsRequired = true
                },
                new Option<string>("the-root-option-no-description-default-arg",
                ...
                new Option<string>("the-root-option-no-default-arg", aliases: new string[] {"--the-root-option-no-default-arg", "-tronda"}) {
                    Description = "the-root-option-no-default-description",
                    ArgumentHelpName = "the-root-option-arg-no-default-arg",
                    IsRequired = true
                },
                new Option<string>("the-root-option-default-arg", aliases: new string[] {"--the-root-option-default-arg", "-troda"}, () => "the-root-option-arg-value") 
                {
                    Description = "the-root-option-default-arg-description",
                    ArgumentHelpName = "the-root-option-arg",
                },
                new Option<FileAccess>("the-root-option-enum-arg", aliases: new string[] {"--the-root-option-enum-arg", "-troea"}, () => FileAccess.Read) 
                {
                    Description = "the-root-option-description",
                },
                new Option<FileAccess>("the-root-option-required-enum-arg", aliases: new string[] {"--the-root-option-required-enum-arg", "-trorea"}, () => FileAccess.Read) 
                {
                    Description = "the-root-option-description",
                    IsRequired = true
                },
                new Option<bool>("the-root-option-multi-line-description", aliases: new string[] {"--the-root-option-multi-line-description", "-tromld"}) {
