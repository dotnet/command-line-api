...
namespace System.CommandLine.Tests
{
    public class InvocationTests
    {
        ...
        //                        "command", "",
        //                        cmd =>
        //                            cmd.AddOption("i", "", iArgs => iArgs.ParseArgumentsAs<int>())
        //                               .AddOption("s", "", sArgs => sArgs.ParseArgumentsAs<string[]>())
        //                               .OnExecute(InvokeMe))
        //                    .BuildCommandDefinition();
        //
        //            var result = commandDefinition.Parse("command -i 123 -s one -s two -s three");
        //
        //            result.Invoke();
        //
        //            wasCalled.Should().BeTrue();
        //
        //            void InvokeMe(int i, string[] s)
        //            {
        //                wasCalled = true;
        //            }
        //        }
