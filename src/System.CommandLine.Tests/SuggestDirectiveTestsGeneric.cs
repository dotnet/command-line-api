...
{
    public class SuggestDirectiveTestsGeneric
    {
        ...
        public SuggestDirectiveTestsGeneric()
        {
            _fruitOption = new Option<string, SuggestionTestObjectPlain>("--fruit")
            .AddSuggestions("apple", "banana", "cherry");

            _vegetableOption = new Option<string, SuggestionTestObjectPlain>(
                "--vegetable",
                new Argument<string>())
            .AddSuggestions((_, __) => new[] { "asparagus", "broccoli", "carrot" });

            _eatCommand = new Command<SuggestionTestObjectPlain>("eat")
            {
                _fruitOption,
                _vegetableOption
            };
        ...
        public async Task It_writes_suggestions_for_partial_subcommand_aliases_under_root_command()
        {
            var parser = new CommandLineBuilder()
                         ...
                         .AddCommand(new Command<SuggestionTestObjectPlain>("wash-dishes"))
                         .UseSuggestDirective()
                         .Build();
        ...
        public async Task It_writes_suggestions_for_partial_option_and_subcommand_aliases_under_root_command_with_an_argument()
        {
            var command = new Command("parent")
                          {
                              new Command("child"),
                              new Option<string, SuggestionTestObjectPlain>("--option1"),
                              new Option("--option2"),
                              new Argument<string>()
                          };
        ...
        public async Task It_does_not_repeat_suggestion_for_already_specified_bool_option()
        {
            ...
            {
                new Option<bool, SuggestionTestObjectPlain>("--bool-option")
            };
