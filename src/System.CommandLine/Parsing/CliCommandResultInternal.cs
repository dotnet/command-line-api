...
namespace System.CommandLine.Parsing
{
        ...
        : CliSymbolResultInternal
    {
        ...
        public IReadOnlyList<CliValueResult> ValueResults => Children.Select(GetValueResult).OfType<CliValueResult>().ToList();
        ...
        internal override bool UseDefaultValueFor(CliArgumentResultInternal argumentResult)
