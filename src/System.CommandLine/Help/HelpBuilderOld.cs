...
namespace System.CommandLine.Help
{
    public class HelpBuilderOld : IHelpBuilder
    {
        ...
        private static class HelpSection
        {
            ...
            private static void AppendHeading(HelpBuilderOld builder, string? title = null)
            {
            ...
            private static void AddDescription(HelpBuilderOld builder, string? description = null)
            {
                if (string.IsNullOrWhiteSpace(description))
                {
                    return;
            ...
            private static void AddInvocation(HelpBuilderOld builder, IReadOnlyCollection<HelpItem> helpItems)
            {
